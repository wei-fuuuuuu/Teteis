...
import Image3d from './MyAdd/Image3d.vue';
import {ref} from 'vue';
import Drawer from './MyAdd/Drawer.vue';
...
<template>  
    <el-container style="position: relative; z-index: 2;">
      <el-header>
      </el-header>
      <el-main >
        <div class="game">
        ...
        <div class="right-div">
            ...
            <el-button class="play" @click="stopGame()">
            开始
            </el-button>
        ...
        <div class="control">
          <el-button class="change bt" @click="change1()">变化</el-button>
          <div class="zy">
            <el-button class="left bt" @click="moveLeft()">向左</el-button>
            <el-button class="right bt" @click="moveRight()">向右</el-button>
          </div>
          <el-button class="down bt" @click="moveDown()">向下</el-button>
        </div>
    </div>
      </el-main>
      <el-footer> 
